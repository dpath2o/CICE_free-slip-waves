...
#    ax.yaxis.set_ticks(np.arange(minval, maxval+step, step))
    ...
    try:
        outfile = 'figs/{}_{}_base-{}.png'.format(field_tmp.replace(' ','_'),casename.replace(' ','_'),base_casename.replace(' ','_'))
    except:
        outfile = 'figs/{}_{}.png'.format(field_tmp.replace(' ','_'), casename.replace(' ','_'))
